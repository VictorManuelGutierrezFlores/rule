...
<div class="" style="background-image:url(/img/confetti.gif); background-size: cover; background-position:center;background-repeat: repeat;">
    ...
    <div class="space-y-1 pb-8 bg-fixed flex-col min-h-screen" style="background-image:url(/img/logo_rule-png.png);background-size: 15%; background-position:left top;background-repeat: no-repeat;">
        ...
        <div class="flex-col max-w-sm mx-auto mt-6 space-y-5 p-5 rounded-t-lg rounded-b-lg">
            ...
            <!--Boton para finalizar juego-->
                <button type="button" class="text-4xl text-white bg-[#D61C4E] hover:bg-[#D61C4E]/90 focus:ring-4 focus:outline-none focus:ring-[#D61C4E]/50 font-just rounded-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#D61C4E]/55 mr-2 mb-2 transition ease-in-out delay-150 hover:-translate hover:scale-105">
                    <a href="/">
                        Jugar de Nuevo
                    </a>
                </button>
