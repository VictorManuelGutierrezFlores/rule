...
<div class="flex-col max-w-sm mx-auto mt-3 space-y-5 p-5 rounded-t-lg rounded-b-lg ">
    ...
    <a href="/comienzajuego">
        <button type="button" class="text-white bg-[#D61C4E] focus:outline-none font-just text-4xl rounded-lg px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 transition ease-in-out delay-150 hover:-translate hover:scale-105 ">
            Empezar partida
        </button>
    </a>
</div>
