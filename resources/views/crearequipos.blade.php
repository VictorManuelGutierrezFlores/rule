...
>>>>>>> ea0eb14ff2c34e5d040c7342e8acce352fa35fe5
...
<p class="font-just text-center text-xl pb-0 pt-20 text-6xl">Nombra a tus equipos</p>
=======

<div class="space-y-1 pb-8 bg-fixed flex-col " style="background-image:url(/img/bg-numeros.jpg);background-size: 40%; background-position:left top;background-repeat: no-repeat;">
<div class="flex-col max-w-sm mx-auto mt-8 space-y-5 p-5 rounded-t-lg rounded-b-lg ">

<!--DIV EQUIPOS-->
<p class="font-just text-center text-xl pb-0 text-6xl">Nombra a tus equipos</p>
>>>>>>> ea0eb14ff2c34e5d040c7342e8acce352fa35fe5
...
=======
    <button type="button" class="text-white bg-[#D61C4E] hover:bg-[#D61C4E]/90 focus:ring-4 focus:outline-none focus:ring-[#D61C4E]/50 font-just text-4xl rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#D61C4E]/55 mr-2 mb-2">
>>>>>>> ea0eb14ff2c34e5d040c7342e8acce352fa35fe5
